...
@SourceType(value = "DynamicsAXARP", label = "DynamicsAX",uiConfig = "dynamicsax-layout.json")
public class DynamicsAXConf extends AbstractArpConf<DynamicsAXConf> {
  private static final String ARP_FILENAME = "arp/implementation/dynamicsax-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.dynamicsax.DynamicsAXDriver";
